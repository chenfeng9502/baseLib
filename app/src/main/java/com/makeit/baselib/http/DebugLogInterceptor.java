                ...
                if (isPlaintext(buffer)) {
                    ...
                    if (requestBody instanceof FormBody) {
                        ...
                        for (int i = 0; i < body.size(); i++) {
                            ...
                            bufferString.append(URLDecoder.decode(name + "=" + value, charset.toString()));
                            bufferString.append("\n");
                        }
                    } else {
                        bufferString.append(buffer.readString(charset));
                    }

                    logger.log(LOG_PREFIX + bufferString.toString());
...
//                    logger.log(LOG_PREFIX + StringEscapeUtils.unescapeHtml());
                    if (contentType != null && "json".equals(contentType.subtype())) {
                        logger.log(LOG_PREFIX + "\n" + JSONObject.toJSONString(bufferString));
                    }
                }
