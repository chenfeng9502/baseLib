...
//
//        return if (state == Environment.MEDIA_MOUNTED) Environment.getExternalStorageDirectory().absolutePath
//        else
//            App.getContext().cacheDir.absolutePath
        return (BaseApp.getContext().getExternalFilesDir(null)?.absolutePath
            ?: BaseApp.getContext().cacheDir.absolutePath)
    }
